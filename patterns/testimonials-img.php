...
?>
<!-- wp:heading -->
<h2 class="wp-block-heading">What my clients say</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|60"}}},"fontSize":"medium"} -->
<p class="has-medium-font-size" style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--60)">Check out my clients' reviews to see what they have to say about my work.</p>
<!-- /wp:paragraph -->
...
<p class="has-medium-font-size">Papanek created a stunning website that perfectly captured our brand image and enhanced our online presence. Highly recommended.</p>
<!-- /wp:paragraph -->
