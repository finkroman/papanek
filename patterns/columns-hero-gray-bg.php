...
<h2 class="wp-block-heading">Create perfect<br>landing pages<br>with Papanek</h2>
<!-- /wp:heading -->
...
<p class="mobile-no-br has-normal-font-size" style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--60);line-height:1.5">Papanek is a stunning WordPress theme featuring a clean and minimalist design.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button">My projects</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
