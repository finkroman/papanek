...
<!-- wp:column {"verticalAlignment":"center","width":"66.66%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.66%"><!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0"}}},"fontSize":"normal"} -->
<p class="has-normal-font-size" style="margin-top:0">We will deliver your item within 2 hours or refund the fee.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:column -->
...
<!-- wp:column {"verticalAlignment":"center","width":"66.66%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.66%"><!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0"}}},"fontSize":"normal"} -->
<p class="has-normal-font-size" style="margin-top:0">Purchase risk-free with our money-back guarantee</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:column --></div>
