...
<h2 class="wp-block-heading">Create perfect landing pages</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|60"}}}} -->
<p style="margin-bottom:var(--wp--preset--spacing--60)">Papanek is a stunning WordPress theme featuring a clean and minimalist design.</p>
<!-- /wp:paragraph -->
