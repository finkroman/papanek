...
<h1 class="wp-block-heading" style="margin-top:0;margin-bottom:0">I'm a designer and WordPress developer</h1>
<!-- /wp:heading -->
...
<p class="mobile-no-br has-normal-font-size" style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--60);line-height:1.5">Hi, my name is Papanek. I'm a designer and WordPress developer. I can build your website from scratch. Check out <a href="#">my portfolio</a> and <a href="#">contact me</a>.</p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-fill"} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button">Contact me</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button">My portfolio</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
