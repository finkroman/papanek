...
<h1 class="wp-block-heading" style="line-height:1.3">Create perfect landing pages</h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/charlesdeluvio-Lks7vei-eAg-unsplash.jpg" alt=""/></figure>
<!-- /wp:image -->