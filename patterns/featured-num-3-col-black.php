...
<p class="has-normal-font-size" style="margin-top:0">Websites<br>created</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p class="has-background-color has-text-color has-normal-font-size" style="margin-top:0">Happy<br>clients</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0"}}},"textColor":"background","fontSize":"normal"} -->
<p class="has-background-color has-text-color has-normal-font-size" style="margin-top:0">Years<br>experience</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
